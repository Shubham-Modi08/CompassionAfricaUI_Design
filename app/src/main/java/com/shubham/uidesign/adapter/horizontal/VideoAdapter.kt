...
class VideoAdapter(private val list: ArrayList<Data>) :
    RecyclerView.Adapter<VideoAdapter.MyView>() {
    class MyView(view: View) : RecyclerView.ViewHolder(view) {
        var imageView: ImageView = view.findViewById(R.id.video_image)
        var textView: TextView = view.findViewById(R.id.video_title)
