...
class InstagramAdapter(private val list: ArrayList<Data>) :
    RecyclerView.Adapter<InstagramAdapter.MyView>() {
    class MyView(view: View) : RecyclerView.ViewHolder(view) {
        var imageView: ImageView = view.findViewById(R.id.instagram_image)
